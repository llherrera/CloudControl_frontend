export const BancoProyectoIcon = ( color: string = 'white' ) => {
    return (
        <svg 
            width="60" 
            height="60" 
...
export const PlanIndicativoIcon = ( color: string = 'white' ) => {
    return (
        <svg 
            width="60" 
            height="60" 
...
export const PlanAccionIcon = ( color: string = 'white' ) => {
    return (
        <svg 
            width="46" 
            height="48" 
...
export const POAIIcon = ( color: string = 'white' ) => {
    return (
        <svg 
            width="46" 
            height="46" 
